...
export const updateimageemployee=(post,id)=>async(dispatch)=>{
    try {
       const {data}=await api.updateemployeeimage(post,id) 
       dispatch({type:UPDATE_IMAGE_EMPLOYEE,payload:data})
    } catch (error) {
        console.log(error)
    }
}