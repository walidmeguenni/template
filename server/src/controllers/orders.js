...
exports.PostOrders = async (req, res, next) => {
  ...
  const { name, quantity} = req.body.data;
  console.log(req.body)
  const orders = new Order({ name, quantity,joined:newdate ,user:req.userId});
...
exports.UpdateOrder = async (req, res, next) => {
  ...
  await Order.findByIdAndUpdate({_id : id}, { name, quantity }, { new: true });
