...
exports.Postemployees = async (req, res, next) => {
  ...
  const { fullname, age, dateNaissance, phone,address,gender,salary,role} = req.body;
  const employees = new Employee({fullname, age, dateNaissance, phone,address,gender,salary,role,EmployeeImage:req.file.path,joined:newdate ,user:req.userId});
  try {  
...
exports.Updateemployee = async (req, res, next) => {
  ...
  const employees = { fullname, age, dateNaissance, phone,address,gender,salary,role,EmployeeImage:req.file.path,_id:id};
  await Employee.findByIdAndUpdate({_id : id}, employees, { new: true });
