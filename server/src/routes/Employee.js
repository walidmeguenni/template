...
router.patch('/:id',checkAuth,employeeControllers.Updateemployee);

router.patch('/updateemployeeimage/:id',checkAuth,upload.single('EmployeeImage'),employeeControllers.UpadteEmployeeImage);
