...
router.put('/changepassword/:id',userControllers.ForgotPassword);
router.get('/logout/:id',userControllers.LOGOUT);
router.delete('/:id',checkAuth,userControllers.deleteUser);
router.get('/confirm/:token',userControllers.verifyUser);
router.get('/change/:token',userControllers.verifyToken);
