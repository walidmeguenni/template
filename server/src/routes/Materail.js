...
router.patch('/:id',checkAuth,MaterailControllers.UpdateMaterail);

router.patch('/updatematerailimage/:id',checkAuth,upload.single('MaterailImage'),MaterailControllers.UpadteMaterialImage);
